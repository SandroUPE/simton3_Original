 ...
 * 
 */
package br.upe.jol.metaheuristics.mopsocdr;
 ...
 *
 */
public class MOPSOCDR extends Algorithm<Double> {
	...
	public MOPSOCDR(int populationSize, int maxIterations, Problem<Double> problem){
