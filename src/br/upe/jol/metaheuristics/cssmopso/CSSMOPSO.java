 ...
 * 
 */
package br.upe.jol.metaheuristics.cssmopso;
 ...
 *
 */
public class CSSMOPSO extends Algorithm<Double> {
	...
	public CSSMOPSO(int populationSize, int maxIterations, Problem<Double> problem){
