 ...
 * 
 */
package br.upe.jol.metaheuristics.dnpso;
 ...
 *
 */
public class DNPSO extends Algorithm<Double> {
	...
	public DNPSO(int populationSize, int maxIterations, Problem<Double> problem){
