...
public class Simul3ObjApplet extends SimulONDApplet{
	...
	private void createGUI() {
		...
		chkAutoAjuste = new JCheckBox("Auto ajuste dos valores dos eixos");
		chkAutoAjuste.setSelected(true);
		chkAutoAjuste.setPreferredSize(defaultDimension);
	    ...
	    btnProcurarExp.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
		        ...
		        if (returnVal == JFileChooser.APPROVE_OPTION) {
					...
					ParetoCanvas.TITULO_EIXO_X = "GASTO DE ENERGIA";
					sprite.atualizarExperimento(solutionSet1, new int[]{450,315}, 0.5, 900, 630, 0);
					repaint();
				} 
			}
