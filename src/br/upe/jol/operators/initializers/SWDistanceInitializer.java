 ...
 * @since 01/01/2014
 */
public class SWDistanceInitializer extends Initializer<Integer> {
	...
	public SWDistanceInitializer() {
		this(14, 1.0 / (14 - 1), 0.40, null, 3, "swt");
	}

	public SWDistanceInitializer(int numNodes, double minDensity, double maxDensity, Double[][] distances, int ampLabel, String prefix) {
...
//			problem.evaluateConstraints(solution);
	...
	/**
	 * @return o valor do atributo numNodes
	 */
	...
	/**
	 * Altera o valor do atributo numNodes
	 * @param numNodes O valor para setar em numNodes
	 */
