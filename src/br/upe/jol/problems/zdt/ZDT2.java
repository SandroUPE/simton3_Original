 ...
 *
 */
public class ZDT2 extends Problem<Double> {
	
	public ZDT2(int numberOfVariables, int numberOfObjectives) {
		super(numberOfVariables, numberOfObjectives, "ZDT2");
	...
	public void evaluate(Solution<Double> solution) {
		...
		double h = 1 - ((variables[0]/g)*(variables[0]/g));
