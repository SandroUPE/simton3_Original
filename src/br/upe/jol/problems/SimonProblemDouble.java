...
import br.upe.jol.problems.simton.UnreliableSimulationException;

public class SimonProblemDouble extends Problem<Double> {
	private static final SimtonProblem problemInt = new SimtonProblem(14, 2);
	...
	private static boolean usarCache = true;
	...
	public static final SimonProblemDouble problemDouble = new SimonProblemDouble(14, 2);

	public SimonProblemDouble(int numberOfNodes_ppr, int numberOfObjectives) {
