...
/**
 * Esta classe foi adaptada a partir da classe DTLZ6 do framework JMetal.
 * 
 * @author Erick Barboza
 */
public class DTLZ6 extends Problem<Double> {

	public DTLZ6(int numberOfVariables, int numberOfObjectives) {
		super(numberOfVariables, numberOfObjectives, "DTLZ6");
