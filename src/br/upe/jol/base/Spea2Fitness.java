...
public class Spea2Fitness {
	 /**
	   ...
	   */
	  private static final DistanceCalculator distance_ = DistanceCalculator.getInstance();
	  ...
	  public Spea2Fitness(SolutionSet solutionSet) {
	    distance     = distance_.getDistanceMatrix(solutionSet);        
	  ...
	  */
	  public SolutionSet environmentalSelection(int size){        
	    ...
	    double [][] distance = distance_.getDistanceMatrix(aux);   
