...
public abstract class Problem<T> implements Serializable {
	...
	/**
	 * @return Valor diferencial para c�lculo do hypervolume, quando uma regi�o
	 *         � conhecida por ser inalcan��vel
	 */
	...
	/**
	 * M�todo acessor para obter o valor do atributo problemName.
	 * 
	...
	/**
	 * M�todo acessor para obter o valor do atributo lowerLimit.
	 * 
	...
	/**
	 * M�todo acessor para obter o valor do atributo upperLimit.
	 * 
	...
	/**
	 * M�todo acessor para obter o valor do atributo lowerLimitObjective.
	 * 
	...
	/**
	 * M�todo acessor para obter o valor do atributo upperLimitObjective.
	 * 
