 ...
 * Nome				Data		Descrição
 * ****************************************************************************
 * Danilo Araújo	27/05/2014		Versão inicial
 * ****************************************************************************
 */
...
public class PCA {
        ...
        public double[] getEigenValues() throws PCAException {          
                validateEigenValues();
                double[] v = new double[eigenValues.getDimension()];
                for (int i = 0; i < v.length; i++) {
                	v[i] = eigenValues.getEntry(i);
                }
                return v;           
        }
        ...
        public void transform() throws PCAException {
                ...
                try {
                        ...
                        EigenDecomposition eDecomp = new EigenDecomposition(covMatrix,0.0);
